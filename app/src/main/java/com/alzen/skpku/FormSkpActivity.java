...
<<<<<<< HEAD
        ...
        /*
         * Saat edit, isi tingkat lama hanya sekali.
         */
        if (isInitialEditLoad && editSkp != null) {
...
<<<<<<< HEAD
        ...
        /*
         * Saat edit, isi peran lama hanya sekali.
         */
        if (isInitialEditLoad && editSkp != null) {
...
<<<<<<< HEAD
        ...
        /*
         * Saat edit, isi mode lama hanya sekali.
         * Setelah mode selesai diisi, isInitialEditLoad dibuat false
         * agar spinner tidak dipaksa kembali ke data lama.
         */
        if (isInitialEditLoad && editSkp != null) {
            spMode.post(() -> {
                setSpinnerSelection(spMode, editSkp.getMode_kegiatan());

                if (spMode.getSelectedItem() != null) {
                    selectedMode = spMode.getSelectedItem().toString();
                }
...
<<<<<<< HEAD
                ...
                if (selectedFileUri != null
                        ...
                        && !existingStoragePath.trim().isEmpty()
                        && latestStoragePath != null
                        && !latestStoragePath.trim().isEmpty()
                        && !existingStoragePath.equals(latestStoragePath)) {

                    SupabaseClient.deleteFile(existingStoragePath, new SupabaseClient.SupabaseCallback() {
                        @Override
                        public void onSuccess(String responseBody) {
                            // File lama berhasil dihapus. Tidak perlu aksi tambahan.
                        }

                        @Override
                        public void onFailure(String errorMessage) {
                            // Jika gagal hapus file lama, data tetap sudah berhasil diupdate.
                        }
                    });
                }
